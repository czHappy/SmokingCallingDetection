...
sys.path.insert(0, '/home/sk49/workspace/mengjunfeng/resnest/encoding/lib')
# print(sys.path)
# print("os.path.realpath(__file__)=%s" % os.path.realpath(__file__))

# sys.path.append('/home/sk49/workspace/mengjunfeng/resnest')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    trainset = datasets.ImageFolder(root='../senet.pytorch/data/train_yolov3', transform=transform_train)
    train_sampler = torch.utils.data.distributed.DistributedSampler(trainset)
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=False, num_workers=args.workers, sampler=train_sampler)

    valset = datasets.ImageFolder(root='../senet.pytorch/data/val_yolov3', transform=transform_val)
    val_sampler = torch.utils.data.distributed.DistributedSampler(valset, shuffle=False)
    val_loader = torch.utils.data.DataLoader(valset, batch_size=args.test_batch_size, shuffle=False, num_workers=args.workers, sampler=val_sampler)
